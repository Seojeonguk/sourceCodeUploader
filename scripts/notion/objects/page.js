 ...
 * @param {Object} param - Object containing the type and payload for creating the page property
 * @param {string} param.type - The type of page property to create
 * @param {Object} param.payload - The payload containing the necessary data for creating the page property
 ...
 * @param {string} param.key - The key name of the date property
 ...
 */
export const createDate = ({ key, start = new Date(), end = null }) => {
  return {
    [key]: {
      [PROPERTY_TYPE.DATE]: {
        start,
 ...
 * @param {string} params.key - The key name of the multi-select property
 ...
 */
export const createMultiSelect = ({ key, selections = [] }) => {
  return {
    [key]: {
 ...
 * @param {string} params.key - The key for the select property
